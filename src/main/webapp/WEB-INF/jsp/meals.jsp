...
<section>
    ...
    <hr/>
    <a href="mealAdd"><spring:message code="meal.add"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="mealUpdate?&id=${meal.id}"><spring:message code="meal.update"/></a></td>
                <td><a href="mealDelete?&id=${meal.id}"><spring:message code="meal.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
